...
class AliasApi:
    ...
    def resolve_competition_alias_by_id(
        ...
        _param = self._resolve_competition_alias_by_id_serialize(
            id=id,
    ...
    def _resolve_competition_alias_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/competition/{id}/alias',
    ...
    def resolve_competition_id_by_alias(
        ...
        _param = self._resolve_competition_id_by_alias_serialize(
            alias=alias,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _resolve_competition_id_by_alias_serialize(
        self,
        alias,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/competition/alias/{alias}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def resolve_match_alias_by_id(
        ...
        _param = self._resolve_match_alias_by_id_serialize(
            match_id=match_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def resolve_match_alias_by_id_with_http_info(
        self,
        match_id: Annotated[StrictStr, Field(description="Match ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def resolve_match_alias_by_id_without_preload_content(
        self,
        match_id: Annotated[StrictStr, Field(description="Match ID")],
        _request_timeout: Union[
            None,
    ...
    def _resolve_match_alias_by_id_serialize(
        self,
        match_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/competition/match/{matchId}/alias',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def resolve_match_id_by_alias(
        self,
        alias: Annotated[StrictStr, Field(description="Match alias")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._resolve_match_id_by_alias_serialize(
            alias=alias,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def resolve_match_id_by_alias_with_http_info(
        self,
        alias: Annotated[StrictStr, Field(description="Match alias")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def resolve_match_id_by_alias_without_preload_content(
        self,
        alias: Annotated[StrictStr, Field(description="Match alias")],
        _request_timeout: Union[
            None,
    ...
    def _resolve_match_id_by_alias_serialize(
        self,
        alias,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/competition/match/alias/{alias}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
